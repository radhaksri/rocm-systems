...
inline constexpr auto k_image_ext_api = callback_domain_definition<SdkBackend>{
    .meta =
        domain_descriptor{
            .name  = "hsa_image_ext_api",
            .id    = SdkBackend::CALLBACK_TRACING_HSA_IMAGE_EXT_API,
            .mode  = collection_mode::callback,
            .group = domain_group{ .name = "hsa_api" },
        },
    .on_record = tracing_callback_dispatcher<
        SdkBackend, on_tracing_api_enter<SdkBackend, Externals, image_ext_api_category>,
        on_tracing_api_exit<SdkBackend, Externals, image_ext_api_category>>::callback,
