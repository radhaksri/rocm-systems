...
public:
  ...
  /// @brief Apply interrupt-handler side effects after a register write lands.
  ///
  ...
  ///
  /// @param[in] byte_offset Where the write landed in the register aperture.
  /// @param[in] memory Unused; present to implement the common block hook.
