...
/// passes the rest to it. Callers supply the hardware VMID, process address
/// space, engine or ring, and interrupt-hierarchy node that identify the work
/// being reported. Fields without a meaningful source remain zero.
